...
uint8_t adc_interval = ADC_INTERVAL_NUM;				// Number of Timer0 ISR executions between each ADC conversion
...
void initialize(void) {
	...
	OCR2 = 107;							// f = 100Hz
	TCCR2 = (1<<WGM21)|(7<<CS20);		// clk/1024, CTC, mode 2 on page 117
	
	// ADC
	ADMUX=0x46;							// Aref=Avcc, right adjust result, input=ADC6
