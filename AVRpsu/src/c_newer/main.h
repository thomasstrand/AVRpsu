...
#define ADC_INTERVAL_NUM	5	// Numeric. Remember: Alternating ADC channels => f*2
#define ADC_INTERVAL_GRA	1	// Graphic. fs = 100Hz / 2x
...
#define SWAP_ADC_CH			(ADMUX=((ADMUX)^(0x01)))			// Swap ADC channel
